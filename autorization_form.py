...
name_input.setStyleSheet("font-size: 18px; font-weight: bold; background-color: #F3F29A;"
...
feedback = QTextEdit()
feedback.setStyleSheet("font-size: 18px; font-weight: bold; background-color: #F3F29A;"
                         "padding: 5px; color: #000;")
line.addWidget(feedback)
feedback.hide()
